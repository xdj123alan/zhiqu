package com.deepflow.gateway.controller;
...
public class SwaggerHandler {
    ...
    public Mono<ResponseEntity<SecurityConfiguration>> securityConfiguration(){
        return Mono.just(//
                new ResponseEntity<>(Optional.ofNullable(securityConfiguration)//
    ...
    public Mono<ResponseEntity<UiConfiguration>> uiConfiguration(){
        return Mono.just(//
                new ResponseEntity<>(Optional.ofNullable(uiConfiguration)//
